...
namespace Trabalho_pratico
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bem vindo, qual tarefa deseja realizar?");            
            Console.WriteLine("1 - Tarefa 2");
            Console.WriteLine("2 - Desafio 3");
            Console.WriteLine("3 - Sair");
            int escolhaTarefa = int.Parse(Console.ReadLine());
            Console.Clear();
            ...
            {
                Console.WriteLine("Digite o número de cidades:");
                int N = int.Parse(Console.ReadLine());
                Console.WriteLine("Digite o número de trechos:");             
                int M = int.Parse(Console.ReadLine());

                Cidade cidade = new Cidade(N, M);
                cidade.Construir();

                cidade.ResolverDesafio();
                Console.ReadLine();
            }
        }
    }
